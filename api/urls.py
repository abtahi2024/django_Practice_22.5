...
from libarayapp.views import AuthorViewSet,BookViewSet,BorrowRecordViewSet,MemberViewSet,BookImagesViewSet
from Member.views import CartViewSet,CartItemViewSet,OrderViewset
...
book = routers.NestedDefaultRouter(router, 'books', lookup='book')
book.register('images', BookImagesViewSet, basename='book-images')
